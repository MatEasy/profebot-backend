...
public class JustificationsService {
    ...
    public static Map<String, String> getCorrectJustificationsFrom(NodeStatus.ChangeTypes source, String comparatorOperator){
    ...
    private static Map<String, String> createTextsFrom(String optionJustification, String correctOptionJustification, String summaryJustification, String comparatorOperator){
        Map<String, String> justifications = new HashMap<>();
        justifications.put("option", optionJustification.replace("/comparador/", textOfComparator(comparatorOperator)));
        justifications.put("correctOptionJustification", correctOptionJustification.replace("/comparador/", textOfComparator(comparatorOperator)));
