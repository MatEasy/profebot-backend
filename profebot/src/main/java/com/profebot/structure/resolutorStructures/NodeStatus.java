...
public class NodeStatus {
  ...
  private final List<NodeStatus> substeps;
  ...
  public static NodeStatus nodeChanged(ChangeTypes changeType, TreeNode oldNode, TreeNode newNode, Boolean defaultChangeGroup,
                                       List<NodeStatus> substeps) {
