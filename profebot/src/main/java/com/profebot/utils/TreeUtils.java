...
public class TreeUtils {
  ...
  private static final SimplifyService simplifyService = new SimplifyService();
  ...
  */
  ...
  public static boolean isQuadratic(TreeNode node) {
    ...
    return (secondDegreeTerms.size() + firstDegreeTerms.size() +
  ...
  public static boolean isNegativeProduct(TreeNode node) {
    ...
    return isNegative(node.getLeftNode());
  }
  ...
  public static TreeNode groupConstantCoefficientAndSymbol(TreeNode node) {
    ...
    if (node.esProducto()) {
      ...
      if (node.getRightNode().esPotencia()) {
        ...
        TreeNode newNode = TreeNode.createPolynomialTerm("X", node.getRightNode().getRightNode().getIntegerValue(),
            node.getRightNode().getLeftNode().getIntegerValue());
  ...
  public static boolean haveSameOperatorLevelCode(TreeNode treeNodeA, TreeNode treeNodeB) {
    ...
    if (operatorLevelA == null || operatorLevelB == null) {
      return false;
    }
